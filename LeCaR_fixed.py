...
class LeCaR_fixed(page_replacement_algorithm):

#     def __init__(self, N, visualization = True):
    def __init__(self, cache_size, fixed_weight, learning_rate=0, initial_weight=0.5, discount_rate=1, visualize=0):
        ...
        self.W = np.array([w,1-w], dtype=np.float32)
...
#             l2, = plt.plot(X,Y2, 'b-', label='W_lfu',linewidth=1)
            ...
            print('lru_cache_miss = ', self.lru_hits)
            print('lfu_cache_miss = ', self.lfu_hits)
