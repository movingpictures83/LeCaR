...
class LeCaR4(page_replacement_algorithm):
...
#     def __init__(self, N, visualization = True):
    def __init__(self, cache_size, learning_rate=0, initial_weight=0.5, discount_rate=1, visualize=0):
        ...
        self.learning_rates = []
        self.discounted_learning_rates = []
        self.discount_rates = []
...
#         return np.array([self.pollution_dat_x,self.pollution_dat_y ]).T
    ...
    def getDiscountedLearningRates(self):
        return self.discounted_learning_rates

    def getDiscountedRates(self):
        return self.discount_rates
    ...
    def request(self,page) :
        ...
        if page in self.CacheRecency:
            ...
            self.discounted_learning_rates.append(self.learning_rate)
            self.discount_rates.append(0)
        else :
            #####################################################
            ...
            ## Update Weights
            #################
            self.discounted_learning_rates.append(- self.learning_rate * reward[0])
            self.discount_rates.append(- reward[0] )
